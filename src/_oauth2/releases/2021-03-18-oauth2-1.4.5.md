---
layout: post
date: "2021-03-18T10:00:00-07:00"
draft: false
...
title: "New Release of oauth2: Version 1.4.5"
...
The oauth2 gem team has been [working](https://github.com/oauth-xx/oauth2/milestone/1?closed=1) on preparing a version 2.0.0 for release.  It will have some minor breaking changes, and some important bug fixes.  It will have code cleanup, and new features.

**But for many people version 1.4.x has been working fine**, and all they need is a new version, warts and all, which fixes some bugs, adds some features, and allows them to upgrade some dependencies, particularly `jwt` and `faraday`.  So I have [prepared a 1.4.5 release](https://github.com/oauth-xx/oauth2/milestone/7?closed=1).

Here is the relevant section of [CHANGELOG.md](https://github.com/oauth-xx/oauth2/blob/1-4-stable/CHANGELOG.md#145---2021-03-18):
