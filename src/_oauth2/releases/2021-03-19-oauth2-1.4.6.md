...
title: "New Release of oauth2: Version 1.4.6"
...
**But for many people version 1.4.x has been working fine**, and all they need is a new version, warts and all, which fixes some bugs, adds some features, and allows them to upgrade some dependencies, particularly `jwt` and `faraday`.  So I have [prepared a 1.4.6 release](https://github.com/oauth-xx/oauth2/milestone/8?closed=1).

Here is the relevant section of [CHANGELOG.md](https://github.com/oauth-xx/oauth2/blob/1-4-stable/CHANGELOG.md#146---2021-03-18):
